...
PORT = int(os.getenv("GATEWAY_V7_PORT", os.getenv("GATEWAY_V3_PORT", "8300")))
...
DEFAULT_TINY = ["nvidia", "gemini_lite", "gemini_flash", "ollama"]
DEFAULT_LARGE = ["gemini_lite", "gemini_flash", # "gemini_gemma",
                 "nvidia", "ollama"]
            ...
            raise HTTPException(
                503,
                {
                    ...
                    "hint": "Use the Summarizer Agent (V7, not yet implemented). "
                            "For now, chunk the input or set provider=gf explicitly to try Gemini anyway.",
