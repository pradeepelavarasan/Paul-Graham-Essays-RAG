...
def build_providers(cache_store):
    ...
    if k := os.getenv("GEMINI_API_KEY"):
        out["gemini_flash"] = GeminiProvider(k, os.getenv("GEMINI_FLASH_MODEL", "gemini-3.0-flash"), cache_store)
        out["gemini_lite"] = GeminiProvider(k, os.getenv("GEMINI_LITE_MODEL", "gemini-3.1-flash-lite"), cache_store)
        # out["gemini_gemma"] = GeminiProvider(k, os.getenv("GEMINI_GEMMA_MODEL", "gemma-4-31b-it"), cache_store)
